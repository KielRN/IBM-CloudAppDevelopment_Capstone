...
def get_dealerships(request):
    context = {}
    url ='https://smdavidwest-3000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get'
...
def add_review(request, dealer_id):
    if(request.method == "GET"):
        ...
        if(request.user.is_authenticated):
            url = "https://smdavidwest-5000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
            review = dict()
            review["id"] = 1
